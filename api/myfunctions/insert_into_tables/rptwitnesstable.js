  ...
  return new Promise((resolve, reject) => {
    ...
    dbcon.query(query, [Global_Id], (err, result) => {
      if (err) {
        ...
        query =
          "insert into rptwitness (Land_Search_Rptwitness_Id, Parent_Global_Id, Object_Id, Global_Id, Name_Of_The_Witness, CreationDate, Creator_Id, EditDate, Editor_Id, Land_Search_Editor_Id,	 Excel_File_Id,	GeoShape_Zip_Id,	 Land_Search_RegDate) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        dbcon.query(
          ...
          (err, result) => {
            if (err) {
              ...
              console.log(
                "record with Land_Search_Rptwitness_Id " +
                  Land_Search_Rptwitness_Id +
