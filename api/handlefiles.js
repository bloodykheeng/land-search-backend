...
const handlefiles = async (req, res) => {
  ...
  try {
    let ExcelFileId = await getfilestableid(
      "excellfiles",
      "ExcelFiles_Id",
      "FilePathName",
      "ExcellFileName",
      "Date_Registered",
      "LandSearchRegistrarId",
      uuid.v4(),
      excelfilepath,
      excelfilename,
      mydate,
    ...
    let GeoShape_Zip_Id = await getfilestableid(
      "geoshape_zip_files",
      "GeoShape_Zip_Files_Id",
      "FilePathName",
      "GeoShapeFileName",
      "	Date_Registered",
      "LandSearchRegistrarId",
      uuid.v4(),
      geodatabasezip_filepath,
      geodatabasezip_filename,
      mydate,
      userId
    );
    ...
    for (const worksheetname of worksheetnames) {
      ...
      if (worksheetname == "Customary_Land_Dermacation__0") {
        ...
        for (let element of data) {
          ...
          if (
            element.hasOwnProperty("ObjectID") &&
            ...
            let OwnerShipType_id = await gettableid(
              req,
              res,
              "ownershiptype",
              "OwnershipType_Id",
            ...
            let Cla_Certificate_Of_Incorporation_Number =
              element["CLA Certificate of Incorporation Number"];
            ...
            let Easements_Or_Other_Persons_Rights =
              element["Easements / Other Persons Rights"];
            ...
            let Date_Of_The_Interview = new Date(
              element["Date of the Interview"]
            );
            let Interviewed_By = element["Interviewed by"];
            let Status_Of_Survey_Id = await gettableid(
              req,
              res,
              "status_of_survey",
              "Status_Of_Survey_Id",
            ...
            let Creator_Id = await gettableid(
              req,
              res,
              "creator",
              "Creator_Id",
            ...
            let Editor_Id = await gettableid(
              req,
              res,
              "creator",
              "Creator_Id",
            ...
            let Surveyed_Parish_Id = await gettableid(
              req,
              res,
              "parish_or_ward",
              "Parish_Id",
        ...
        for (let element of data) {
          if (
            ...
            let Gender_Id = await gettableid(
              req,
              res,
              "gender",
              "Gender_Id",
            ...
            let Marital_Status_Id = await gettableid(
              req,
              res,
              "marital_status",
              "MaritalStatus_Id",
            ...
            let Address_Id = await gettableid(
              req,
              res,
              "address",
              "Address_Id",
        ...
        for (let element of data) {
          if (
            ...
            try {
              rptneighbor_response.push(
                await rptneighbortable(
        ...
        for (let element of data) {
          if (
            ...
            try {
              rptwitness_response.push(
                await rptwitnesstable(
        ...
        for (let element of data) {
          if (
            ...
            try {
              rptinspection_response.push(
                await rptinspectiontable(
